...
<html>
  ...
  <body>
    ...
    <div id="container">
        ...
        <a id = "five-href" href = "walking.php"><div class="box"><div><p id = "five">Walking</p></div><img id = "five-img" src="img/walking.gif"></div></a>
        <a id = "six-href" style = "visibility:hidden;" href = "walking.php"><div class="box"><div><p id = "six">Jansen Mechanism</p></div><img id = "seven-img" src="img/walking.gif"></div></a>
        <span class="stretch"></span>
        <br>
