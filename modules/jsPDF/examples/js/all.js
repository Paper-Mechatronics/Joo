...
function showAll(){
  ...
  if(numOfLinGears){
    doc.addPage();
    doc.rect(2.5*frameScale,15*frameScale+35+15,177-30,35)
    // doc.text(2.5*frameScale+5,(15)*frameScale+45+10+15,frameLabelArray[2])
    doc.rect(2.5*frameScale,(15+113.4+5)*frameScale+30+15,177-30,35)
    ...
    if(mirror == 1){
      ...
      doc.rect(2.5*frameScale+147+1,15*frameScale+45+15,147,35)
      // doc.text(2.5*frameScale+5+147+1,(15)*frameScale+45+10+15,frameLabelArray[2])
      doc.rect(2.5*frameScale+147+1,(15+113.4+5)*frameScale+48+15,147,35)
